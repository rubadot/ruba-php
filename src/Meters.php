...
class Meters
{
     ...
     * **Scopes**: `meters:write`
     *
     * @param  \Ruba\Models\Components\MeterCreate  $request
     * @return \Ruba\Models\Operations\MetersCreateResponse
    ...
    public function create(Components\MeterCreate $request, ?Options $options = null): Operations\MetersCreateResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\Meter', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  string  $id
     * @return \Ruba\Models\Operations\MetersGetResponse
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     * **Scopes**: `meters:read` `meters:write`
     *
     * @param  ?\Ruba\Models\Operations\MetersListRequest  $request
     * @return \Ruba\Models\Operations\MetersListResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    private function listIndividual(?Operations\MetersListRequest $request = null, ?Options $options = null): Operations\MetersListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\ListResourceMeter', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  ?\Ruba\Models\Operations\MetersListRequest  $request
     * @return \Generator<\Ruba\Models\Operations\MetersListResponse>
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     * **Scopes**: `meters:read` `meters:write`
     *
     * @param  \Ruba\Models\Operations\MetersQuantitiesRequest  $request
     * @return \Ruba\Models\Operations\MetersQuantitiesResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    public function quantities(Operations\MetersQuantitiesRequest $request, ?Options $options = null): Operations\MetersQuantitiesResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\MeterQuantities', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @param  string  $id
     * @return \Ruba\Models\Operations\MetersUpdateResponse
     * @throws \Ruba\Models\Errors\APIException
     */
