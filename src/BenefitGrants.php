...
class BenefitGrants
{
     ...
     *
     * @param  ?\Ruba\Models\Operations\BenefitGrantsListRequest  $request
     * @return \Ruba\Models\Operations\BenefitGrantsListResponse
    ...
    private function listIndividual(?Operations\BenefitGrantsListRequest $request = null, ?Options $options = null): Operations\BenefitGrantsListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\ListResourceBenefitGrant', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  ?\Ruba\Models\Operations\BenefitGrantsListRequest  $request
     * @return \Generator<\Ruba\Models\Operations\BenefitGrantsListResponse>
     * @throws \Ruba\Models\Errors\APIException
     */
