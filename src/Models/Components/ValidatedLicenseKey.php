...
class ValidatedLicenseKey
{
    ...
    /**
     *
     * @var ?\Ruba\Models\Components\LicenseKeyActivationBase $activation
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('activation')]
    #[\Speakeasy\Serializer\Annotation\Type('\Ruba\Models\Components\LicenseKeyActivationBase|null')]
     ...
     * @param  ?\Ruba\Models\Components\LicenseKeyActivationBase  $activation
     * @phpstan-pure
     */
