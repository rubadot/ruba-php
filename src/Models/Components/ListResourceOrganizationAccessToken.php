...
class ListResourceOrganizationAccessToken
{
     ...
     * $items
     *
     * @var array<\Ruba\Models\Components\OrganizationAccessToken> $items
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('items')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Ruba\Models\Components\OrganizationAccessToken>')]
    public array $items;
    ...
    /**
     * @param  array<\Ruba\Models\Components\OrganizationAccessToken>  $items
