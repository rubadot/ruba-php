...
class ListResourceCheckout
{
     ...
     * $items
     *
     * @var array<\Ruba\Models\Components\Checkout> $items
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('items')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Ruba\Models\Components\Checkout>')]
    public array $items;
    ...
    /**
     * @param  array<\Ruba\Models\Components\Checkout>  $items
