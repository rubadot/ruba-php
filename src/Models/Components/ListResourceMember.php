...
class ListResourceMember
{
     ...
     * $items
     *
     * @var array<\Ruba\Models\Components\Member> $items
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('items')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Ruba\Models\Components\Member>')]
    public array $items;
    ...
    /**
     * @param  array<\Ruba\Models\Components\Member>  $items
