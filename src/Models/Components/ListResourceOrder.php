...
class ListResourceOrder
{
     ...
     * $items
     *
     * @var array<\Ruba\Models\Components\Order> $items
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('items')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Ruba\Models\Components\Order>')]
    public array $items;
    ...
    /**
     * @param  array<\Ruba\Models\Components\Order>  $items
