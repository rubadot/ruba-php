...
class ListResourceProduct
{
     ...
     * $items
     *
     * @var array<\Ruba\Models\Components\Product> $items
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('items')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Ruba\Models\Components\Product>')]
    public array $items;
    ...
    /**
     * @param  array<\Ruba\Models\Components\Product>  $items
