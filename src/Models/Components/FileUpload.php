...
class FileUpload
{
    ...
    /**
     *
     * @var \Ruba\Models\Components\S3FileUploadMultipart $upload
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('upload')]
    #[\Speakeasy\Serializer\Annotation\Type('\Ruba\Models\Components\S3FileUploadMultipart')]
     ...
     * @param  int  $size
     * @param  \Ruba\Models\Components\S3FileUploadMultipart  $upload
