...
class ListResourceOrganization
{
     ...
     * $items
     *
     * @var array<\Ruba\Models\Components\Organization> $items
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('items')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Ruba\Models\Components\Organization>')]
    public array $items;
    ...
    /**
     * @param  array<\Ruba\Models\Components\Organization>  $items
