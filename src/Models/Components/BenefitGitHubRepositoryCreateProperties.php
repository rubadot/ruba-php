...
class BenefitGitHubRepositoryCreateProperties
{
     ...
     *
     * @var \Ruba\Models\Components\BenefitGitHubRepositoryCreatePropertiesPermission $permission
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('permission')]
    #[\Speakeasy\Serializer\Annotation\Type('\Ruba\Models\Components\BenefitGitHubRepositoryCreatePropertiesPermission')]
    public BenefitGitHubRepositoryCreatePropertiesPermission $permission;

    /**
     * @param  string  $repositoryOwner
     * @param  string  $repositoryName
     * @param  \Ruba\Models\Components\BenefitGitHubRepositoryCreatePropertiesPermission  $permission
     * @phpstan-pure
     */
