...
class ListResourceCustomerWallet
{
     ...
     * $items
     *
     * @var array<\Ruba\Models\Components\CustomerWallet> $items
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('items')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Ruba\Models\Components\CustomerWallet>')]
    public array $items;
    ...
    /**
     * @param  array<\Ruba\Models\Components\CustomerWallet>  $items
