...
class ListResourceSubscription
{
     ...
     * $items
     *
     * @var array<\Ruba\Models\Components\Subscription> $items
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('items')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Ruba\Models\Components\Subscription>')]
    public array $items;
    ...
    /**
     * @param  array<\Ruba\Models\Components\Subscription>  $items
