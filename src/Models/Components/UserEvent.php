...
class UserEvent
{
     ...
     * $metadata
     *
     * @var array<string, string|int|float|bool|\Ruba\Models\Components\CostMetadataOutput|\Ruba\Models\Components\LLMMetadata> $metadata
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('metadata')]
    #[\Speakeasy\Serializer\Annotation\Type('array<string, string|int|float|bool|\Ruba\Models\Components\CostMetadataOutput|\Ruba\Models\Components\LLMMetadata>')]
     ...
     * @param  string  $name
     * @param  string  $source
     * @param  array<string, string|int|float|bool|\Ruba\Models\Components\CostMetadataOutput|\Ruba\Models\Components\LLMMetadata>  $metadata
