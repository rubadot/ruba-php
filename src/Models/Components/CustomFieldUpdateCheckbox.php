...
class CustomFieldUpdateCheckbox
{
    ...
    /**
     *
     * @var ?\Ruba\Models\Components\CustomFieldCheckboxProperties $properties
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('properties')]
    #[\Speakeasy\Serializer\Annotation\Type('\Ruba\Models\Components\CustomFieldCheckboxProperties|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     * @param  ?string  $name
     * @param  ?string  $slug
     * @param  ?\Ruba\Models\Components\CustomFieldCheckboxProperties  $properties
     * @phpstan-pure
     */
