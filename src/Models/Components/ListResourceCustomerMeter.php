...
class ListResourceCustomerMeter
{
     ...
     * $items
     *
     * @var array<\Ruba\Models\Components\CustomerMeter> $items
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('items')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Ruba\Models\Components\CustomerMeter>')]
    public array $items;
    ...
    /**
     * @param  array<\Ruba\Models\Components\CustomerMeter>  $items
