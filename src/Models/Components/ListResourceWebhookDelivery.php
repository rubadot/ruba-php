...
class ListResourceWebhookDelivery
{
     ...
     * $items
     *
     * @var array<\Ruba\Models\Components\WebhookDelivery> $items
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('items')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Ruba\Models\Components\WebhookDelivery>')]
    public array $items;
    ...
    /**
     * @param  array<\Ruba\Models\Components\WebhookDelivery>  $items
