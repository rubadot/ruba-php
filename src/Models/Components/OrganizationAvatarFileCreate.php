...
class OrganizationAvatarFileCreate
{
    ...
    /**
     *
     * @var \Ruba\Models\Components\S3FileCreateMultipart $upload
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('upload')]
    #[\Speakeasy\Serializer\Annotation\Type('\Ruba\Models\Components\S3FileCreateMultipart')]
     ...
     * @param  int  $size
     * @param  \Ruba\Models\Components\S3FileCreateMultipart  $upload
