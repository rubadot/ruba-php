...
class ListResourceEventTypeWithStats
{
     ...
     * $items
     *
     * @var array<\Ruba\Models\Components\EventTypeWithStats> $items
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('items')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Ruba\Models\Components\EventTypeWithStats>')]
    public array $items;
    ...
    /**
     * @param  array<\Ruba\Models\Components\EventTypeWithStats>  $items
