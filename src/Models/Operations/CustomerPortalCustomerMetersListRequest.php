...
class CustomerPortalCustomerMetersListRequest
{
     ...
     *
     * @var ?array<\Ruba\Models\Components\CustomerCustomerMeterSortProperty> $sorting
     */
     ...
     * @param  ?string  $query
     * @param  ?array<\Ruba\Models\Components\CustomerCustomerMeterSortProperty>  $sorting
     * @phpstan-pure
     */
