...
class RubaCustomers
{
     ...
     *
     * @param  \Ruba\Models\Operations\CustomerPortalCustomersAddPaymentMethodSecurity  $security
     * @param  \Ruba\Models\Components\CustomerPaymentMethodCreate  $request
     * @return \Ruba\Models\Operations\CustomerPortalCustomersAddPaymentMethodResponse
    ...
    public function addPaymentMethod(Operations\CustomerPortalCustomersAddPaymentMethodSecurity $security, Components\CustomerPaymentMethodCreate $request, ?Options $options = null): Operations\CustomerPortalCustomersAddPaymentMethodResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\CustomerPaymentMethodCreateSucceededResponse|\Ruba\Models\Components\CustomerPaymentMethodCreateRequiresActionResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  \Ruba\Models\Operations\CustomerPortalCustomersConfirmPaymentMethodSecurity  $security
     * @param  \Ruba\Models\Components\CustomerPaymentMethodConfirm  $request
     * @return \Ruba\Models\Operations\CustomerPortalCustomersConfirmPaymentMethodResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    public function confirmPaymentMethod(Operations\CustomerPortalCustomersConfirmPaymentMethodSecurity $security, Components\CustomerPaymentMethodConfirm $request, ?Options $options = null): Operations\CustomerPortalCustomersConfirmPaymentMethodResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Errors\CustomerNotReady', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                throw $obj->toException();
            } else {
                throw new \Ruba\Models\Errors\APIException('Unknown content type received', $statusCode, $httpResponse->getBody()->getContents(), $httpResponse);
            }
     ...
     *
     * @param  \Ruba\Models\Operations\CustomerPortalCustomersDeletePaymentMethodSecurity  $security
     * @param  string  $id
     * @return \Ruba\Models\Operations\CustomerPortalCustomersDeletePaymentMethodResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    public function deletePaymentMethod(Operations\CustomerPortalCustomersDeletePaymentMethodSecurity $security, string $id, ?Options $options = null): Operations\CustomerPortalCustomersDeletePaymentMethodResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['204'])) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Errors\PaymentMethodInUseByActiveSubscription', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                throw $obj->toException();
            } else {
                throw new \Ruba\Models\Errors\APIException('Unknown content type received', $statusCode, $httpResponse->getBody()->getContents(), $httpResponse);
            }
     ...
     *
     * @param  \Ruba\Models\Operations\CustomerPortalCustomersGetSecurity  $security
     * @return \Ruba\Models\Operations\CustomerPortalCustomersGetResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    public function get(Operations\CustomerPortalCustomersGetSecurity $security, ?Options $options = null): Operations\CustomerPortalCustomersGetResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\CustomerPortalCustomer', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  \Ruba\Models\Operations\CustomerPortalCustomersListPaymentMethodsSecurity  $security
     * @param  ?int  $page
     * @param  ?int  $limit
     * @return \Ruba\Models\Operations\CustomerPortalCustomersListPaymentMethodsResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    private function listPaymentMethodsIndividual(Operations\CustomerPortalCustomersListPaymentMethodsSecurity $security, ?int $page = null, ?int $limit = null, ?Options $options = null): Operations\CustomerPortalCustomersListPaymentMethodsResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\ListResourceCustomerPaymentMethod', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @param  ?int  $page
     * @param  ?int  $limit
     * @return \Generator<\Ruba\Models\Operations\CustomerPortalCustomersListPaymentMethodsResponse>
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     *
     * @param  \Ruba\Models\Operations\CustomerPortalCustomersUpdateSecurity  $security
     * @param  \Ruba\Models\Components\CustomerPortalCustomerUpdate  $request
     * @return \Ruba\Models\Operations\CustomerPortalCustomersUpdateResponse
     * @throws \Ruba\Models\Errors\APIException
     */
