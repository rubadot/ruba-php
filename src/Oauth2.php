...
class Oauth2
{
     ...
     * Authorize
     *
     * @return \Ruba\Models\Operations\Oauth2AuthorizeResponse
    ...
    public function authorize(?Options $options = null): Operations\Oauth2AuthorizeResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\AuthorizeResponseUser|\Ruba\Models\Components\AuthorizeResponseOrganization', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  \Ruba\Models\Components\IntrospectTokenRequest  $request
     * @return \Ruba\Models\Operations\Oauth2IntrospectTokenResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    public function introspect(Components\IntrospectTokenRequest $request, ?Options $options = null): Operations\Oauth2IntrospectTokenResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\IntrospectTokenResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  \Ruba\Models\Components\AuthorizationCodeTokenRequest|\Ruba\Models\Components\RefreshTokenRequest|\Ruba\Models\Components\WebTokenRequest  $request
     * @return \Ruba\Models\Operations\Oauth2RequestTokenResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    public function token(Components\AuthorizationCodeTokenRequest|Components\RefreshTokenRequest|Components\WebTokenRequest $request, ?Options $options = null): Operations\Oauth2RequestTokenResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\TokenResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  \Ruba\Models\Components\RevokeTokenRequest  $request
     * @return \Ruba\Models\Operations\Oauth2RevokeTokenResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    public function revoke(Components\RevokeTokenRequest $request, ?Options $options = null): Operations\Oauth2RevokeTokenResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\RevokeTokenResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @return \Ruba\Models\Operations\Oauth2UserinfoResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    public function userinfo(?Options $options = null): Operations\Oauth2UserinfoResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\UserInfoUser|\Ruba\Models\Components\UserInfoOrganization', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
