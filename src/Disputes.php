...
class Disputes
{
     ...
     *
     * @param  string  $id
     * @return \Ruba\Models\Operations\DisputesGetResponse
    ...
    public function get(string $id, ?Options $options = null): Operations\DisputesGetResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\Dispute', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * **Scopes**: `disputes:read`
     *
     * @param  ?\Ruba\Models\Operations\DisputesListRequest  $request
     * @return \Ruba\Models\Operations\DisputesListResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    private function listIndividual(?Operations\DisputesListRequest $request = null, ?Options $options = null): Operations\DisputesListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\ListResourceDispute', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  ?\Ruba\Models\Operations\DisputesListRequest  $request
     * @return \Generator<\Ruba\Models\Operations\DisputesListResponse>
     * @throws \Ruba\Models\Errors\APIException
     */
