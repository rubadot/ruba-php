...
class Members
{
     ...
     *
     * @param  \Ruba\Models\Components\MemberCreate  $request
     * @return \Ruba\Models\Operations\MembersCreateMemberResponse
    ...
    public function createMember(Components\MemberCreate $request, ?Options $options = null): Operations\MembersCreateMemberResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\Member', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  string  $id
     * @return \Ruba\Models\Operations\MembersDeleteMemberResponse
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     *
     * @param  string  $id
     * @return \Ruba\Models\Operations\MembersGetMemberResponse
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     * **Scopes**: `members:read` `members:write`
     *
     * @param  ?\Ruba\Models\Operations\MembersListMembersRequest  $request
     * @return \Ruba\Models\Operations\MembersListMembersResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    private function listMembersIndividual(?Operations\MembersListMembersRequest $request = null, ?Options $options = null): Operations\MembersListMembersResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\ListResourceMember', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  ?\Ruba\Models\Operations\MembersListMembersRequest  $request
     * @return \Generator<\Ruba\Models\Operations\MembersListMembersResponse>
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     * @param  string  $id
     * @return \Ruba\Models\Operations\MembersUpdateMemberResponse
     * @throws \Ruba\Models\Errors\APIException
     */
