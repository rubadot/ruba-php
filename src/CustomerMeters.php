...
class CustomerMeters
{
     ...
     *
     * @param  string  $id
     * @return \Ruba\Models\Operations\CustomerMetersGetResponse
    ...
    public function get(string $id, ?Options $options = null): Operations\CustomerMetersGetResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\CustomerMeter', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * **Scopes**: `customer_meters:read`
     *
     * @param  ?\Ruba\Models\Operations\CustomerMetersListRequest  $request
     * @return \Ruba\Models\Operations\CustomerMetersListResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    private function listIndividual(?Operations\CustomerMetersListRequest $request = null, ?Options $options = null): Operations\CustomerMetersListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\ListResourceCustomerMeter', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  ?\Ruba\Models\Operations\CustomerMetersListRequest  $request
     * @return \Generator<\Ruba\Models\Operations\CustomerMetersListResponse>
     * @throws \Ruba\Models\Errors\APIException
     */
