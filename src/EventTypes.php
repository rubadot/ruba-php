...
class EventTypes
{
     ...
     *
     * @param  ?\Ruba\Models\Operations\EventTypesListRequest  $request
     * @return \Ruba\Models\Operations\EventTypesListResponse
    ...
    private function listIndividual(?Operations\EventTypesListRequest $request = null, ?Options $options = null): Operations\EventTypesListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\ListResourceEventTypeWithStats', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  ?\Ruba\Models\Operations\EventTypesListRequest  $request
     * @return \Generator<\Ruba\Models\Operations\EventTypesListResponse>
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     * @param  string  $id
     * @return \Ruba\Models\Operations\EventTypesUpdateResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    public function update(Components\EventTypeUpdate $eventTypeUpdate, string $id, ?Options $options = null): Operations\EventTypesUpdateResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\EventType', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
