...
class Payments
{
     ...
     *
     * @param  string  $id
     * @return \Ruba\Models\Operations\PaymentsGetResponse
    ...
    public function get(string $id, ?Options $options = null): Operations\PaymentsGetResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\CardPayment|\Ruba\Models\Components\GenericPayment', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * **Scopes**: `payments:read`
     *
     * @param  ?\Ruba\Models\Operations\PaymentsListRequest  $request
     * @return \Ruba\Models\Operations\PaymentsListResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    private function listIndividual(?Operations\PaymentsListRequest $request = null, ?Options $options = null): Operations\PaymentsListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\ListResourcePayment', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  ?\Ruba\Models\Operations\PaymentsListRequest  $request
     * @return \Generator<\Ruba\Models\Operations\PaymentsListResponse>
     * @throws \Ruba\Models\Errors\APIException
     */
