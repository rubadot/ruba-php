...
class Organizations
{
     ...
     *
     * @param  \Ruba\Models\Components\OrganizationCreate  $request
     * @return \Ruba\Models\Operations\OrganizationsCreateResponse
    ...
    public function create(Components\OrganizationCreate $request, ?Options $options = null): Operations\OrganizationsCreateResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\Organization', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  string  $id
     * @return \Ruba\Models\Operations\OrganizationsGetResponse
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     * @return \Ruba\Models\Operations\OrganizationsListResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    private function listIndividual(?string $slug = null, ?int $page = null, ?int $limit = null, ?array $sorting = null, ?Options $options = null): Operations\OrganizationsListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\ListResourceOrganization', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @param  ?int  $limit
     * @param  ?array<\Ruba\Models\Components\OrganizationSortProperty>  $sorting
     * @return \Generator<\Ruba\Models\Operations\OrganizationsListResponse>
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     * @param  string  $id
     * @return \Ruba\Models\Operations\OrganizationsUpdateResponse
     * @throws \Ruba\Models\Errors\APIException
     */
