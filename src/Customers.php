...
class Customers
{
     ...
     *
     * @param  \Ruba\Models\Components\CustomerIndividualCreate|\Ruba\Models\Components\CustomerTeamCreate  $request
     * @return \Ruba\Models\Operations\CustomersCreateResponse
    ...
    public function create(Components\CustomerIndividualCreate|Components\CustomerTeamCreate $request, ?Options $options = null): Operations\CustomersCreateResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\CustomerIndividual|\Ruba\Models\Components\CustomerTeam', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @return \Ruba\Models\Operations\CustomersDeleteResponse
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     * @param  ?bool  $anonymize
     * @return \Ruba\Models\Operations\CustomersDeleteExternalResponse
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     * @return \Ruba\Models\Operations\CustomersExportResponse
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     *
     * @param  string  $id
     * @return \Ruba\Models\Operations\CustomersGetResponse
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     *
     * @param  string  $externalId
     * @return \Ruba\Models\Operations\CustomersGetExternalResponse
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     *
     * @param  string  $id
     * @return \Ruba\Models\Operations\CustomersGetStateResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    public function getState(string $id, ?Options $options = null): Operations\CustomersGetStateResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\CustomerStateIndividual|\Ruba\Models\Components\CustomerStateTeam', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  string  $externalId
     * @return \Ruba\Models\Operations\CustomersGetStateExternalResponse
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     * **Scopes**: `customers:read` `customers:write`
     *
     * @param  ?\Ruba\Models\Operations\CustomersListRequest  $request
     * @return \Ruba\Models\Operations\CustomersListResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    private function listIndividual(?Operations\CustomersListRequest $request = null, ?Options $options = null): Operations\CustomersListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\ListResourceCustomer', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  ?\Ruba\Models\Operations\CustomersListRequest  $request
     * @return \Generator<\Ruba\Models\Operations\CustomersListResponse>
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     * @param  string  $id
     * @return \Ruba\Models\Operations\CustomersUpdateResponse
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     * @param  string  $externalId
     * @return \Ruba\Models\Operations\CustomersUpdateExternalResponse
     * @throws \Ruba\Models\Errors\APIException
     */
