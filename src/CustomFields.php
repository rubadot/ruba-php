...
class CustomFields
{
     ...
     *
     * @param  \Ruba\Models\Components\CustomFieldCreateText|\Ruba\Models\Components\CustomFieldCreateNumber|\Ruba\Models\Components\CustomFieldCreateDate|\Ruba\Models\Components\CustomFieldCreateCheckbox|\Ruba\Models\Components\CustomFieldCreateSelect  $request
     * @return \Ruba\Models\Operations\CustomFieldsCreateResponse
    ...
    public function create(Components\CustomFieldCreateText|Components\CustomFieldCreateNumber|Components\CustomFieldCreateDate|Components\CustomFieldCreateCheckbox|Components\CustomFieldCreateSelect $request, ?Options $options = null): Operations\CustomFieldsCreateResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\CustomFieldText|\Ruba\Models\Components\CustomFieldNumber|\Ruba\Models\Components\CustomFieldDate|\Ruba\Models\Components\CustomFieldCheckbox|\Ruba\Models\Components\CustomFieldSelect', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  string  $id
     * @return \Ruba\Models\Operations\CustomFieldsDeleteResponse
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     *
     * @param  string  $id
     * @return \Ruba\Models\Operations\CustomFieldsGetResponse
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     * **Scopes**: `custom_fields:read` `custom_fields:write`
     *
     * @param  ?\Ruba\Models\Operations\CustomFieldsListRequest  $request
     * @return \Ruba\Models\Operations\CustomFieldsListResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    private function listIndividual(?Operations\CustomFieldsListRequest $request = null, ?Options $options = null): Operations\CustomFieldsListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\ListResourceCustomField', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  ?\Ruba\Models\Operations\CustomFieldsListRequest  $request
     * @return \Generator<\Ruba\Models\Operations\CustomFieldsListResponse>
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     * @param  string  $id
     * @return \Ruba\Models\Operations\CustomFieldsUpdateResponse
     * @throws \Ruba\Models\Errors\APIException
     */
