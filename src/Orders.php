...
class Orders
{
     ...
     * @return \Ruba\Models\Operations\OrdersExportResponse
     ...
     *
     * @param  string  $id
     * @return \Ruba\Models\Operations\OrdersGenerateInvoiceResponse
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     *
     * @param  string  $id
     * @return \Ruba\Models\Operations\OrdersGetResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    public function get(string $id, ?Options $options = null): Operations\OrdersGetResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\Order', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  string  $id
     * @return \Ruba\Models\Operations\OrdersInvoiceResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    public function invoice(string $id, ?Options $options = null): Operations\OrdersInvoiceResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\OrderInvoice', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * **Scopes**: `orders:read`
     *
     * @param  ?\Ruba\Models\Operations\OrdersListRequest  $request
     * @return \Ruba\Models\Operations\OrdersListResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    private function listIndividual(?Operations\OrdersListRequest $request = null, ?Options $options = null): Operations\OrdersListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\ListResourceOrder', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  ?\Ruba\Models\Operations\OrdersListRequest  $request
     * @return \Generator<\Ruba\Models\Operations\OrdersListResponse>
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     * @param  string  $id
     * @return \Ruba\Models\Operations\OrdersUpdateResponse
     * @throws \Ruba\Models\Errors\APIException
     */
