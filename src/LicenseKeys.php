...
class LicenseKeys
{
     ...
     *
     * @param  \Ruba\Models\Components\LicenseKeyActivate  $request
     * @return \Ruba\Models\Operations\LicenseKeysActivateResponse
    ...
    public function activate(Components\LicenseKeyActivate $request, ?Options $options = null): Operations\LicenseKeysActivateResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\LicenseKeyActivationRead', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * **Scopes**: `license_keys:write`
     *
     * @param  \Ruba\Models\Components\LicenseKeyDeactivate  $request
     * @return \Ruba\Models\Operations\LicenseKeysDeactivateResponse
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     *
     * @param  string  $id
     * @return \Ruba\Models\Operations\LicenseKeysGetResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    public function get(string $id, ?Options $options = null): Operations\LicenseKeysGetResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\LicenseKeyWithActivations', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Errors\Unauthorized', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                throw $obj->toException();
            } else {
                throw new \Ruba\Models\Errors\APIException('Unknown content type received', $statusCode, $httpResponse->getBody()->getContents(), $httpResponse);
            }
     ...
     * @return \Ruba\Models\Operations\LicenseKeysGetActivationResponse
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     * @param  ?int  $page
     * @param  ?int  $limit
     * @return \Ruba\Models\Operations\LicenseKeysListResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    private function listIndividual(string|array|null $organizationId = null, string|array|null $benefitId = null, ?int $page = null, ?int $limit = null, ?Options $options = null): Operations\LicenseKeysListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\ListResourceLicenseKeyRead', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @param  ?int  $page
     * @param  ?int  $limit
     * @return \Generator<\Ruba\Models\Operations\LicenseKeysListResponse>
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     * @param  string  $id
     * @return \Ruba\Models\Operations\LicenseKeysUpdateResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    public function update(Components\LicenseKeyUpdate $licenseKeyUpdate, string $id, ?Options $options = null): Operations\LicenseKeysUpdateResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\LicenseKeyRead', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * **Scopes**: `license_keys:write`
     *
     * @param  \Ruba\Models\Components\LicenseKeyValidate  $request
     * @return \Ruba\Models\Operations\LicenseKeysValidateResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    public function validate(Components\LicenseKeyValidate $request, ?Options $options = null): Operations\LicenseKeysValidateResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\ValidatedLicenseKey', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
