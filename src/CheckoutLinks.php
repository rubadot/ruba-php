...
class CheckoutLinks
{
     ...
     *
     * @param  \Ruba\Models\Components\CheckoutLinkCreateProductPrice|\Ruba\Models\Components\CheckoutLinkCreateProduct|\Ruba\Models\Components\CheckoutLinkCreateProducts  $request
     * @return \Ruba\Models\Operations\CheckoutLinksCreateResponse
    ...
    public function create(Components\CheckoutLinkCreateProductPrice|Components\CheckoutLinkCreateProduct|Components\CheckoutLinkCreateProducts $request, ?Options $options = null): Operations\CheckoutLinksCreateResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\CheckoutLink', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  string  $id
     * @return \Ruba\Models\Operations\CheckoutLinksDeleteResponse
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     *
     * @param  string  $id
     * @return \Ruba\Models\Operations\CheckoutLinksGetResponse
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     * **Scopes**: `checkout_links:read` `checkout_links:write`
     *
     * @param  ?\Ruba\Models\Operations\CheckoutLinksListRequest  $request
     * @return \Ruba\Models\Operations\CheckoutLinksListResponse
     * @throws \Ruba\Models\Errors\APIException
     */
    private function listIndividual(?Operations\CheckoutLinksListRequest $request = null, ?Options $options = null): Operations\CheckoutLinksListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Ruba\Models\Components\ListResourceCheckoutLink', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  ?\Ruba\Models\Operations\CheckoutLinksListRequest  $request
     * @return \Generator<\Ruba\Models\Operations\CheckoutLinksListResponse>
     * @throws \Ruba\Models\Errors\APIException
     */
     ...
     * @param  string  $id
     * @return \Ruba\Models\Operations\CheckoutLinksUpdateResponse
     * @throws \Ruba\Models\Errors\APIException
     */
